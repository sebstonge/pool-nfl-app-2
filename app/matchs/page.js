...
export default function Matchs() {
  ...
  const [existingQbPick, setExistingQbPick] =
    useState(null);
  ...
  async function loadData() {
    ...
    const remainingOrder =
      fullOrder.filter(
        (player) =>
          !alreadyPickedIds.has(player.id)
      );
